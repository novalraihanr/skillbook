...
<template>
  <DashboardTemplate>
    <template #title>
      <span class="text-sky-300">Welcome Back,</span><span class="text-sky-700"> John Smith</span>!
    </template>
    <template #content>
      <!-- Overview -->
      <div class="mt-10">
        ...
        <div class="mt-5 flex flex-row bg-sky-300 w-fit h-25 pl-5 pr-5 rounded-md">
          <div class="flex flex-row m-auto space-x-40 items-center">
            ...
            <div class="flex flex-row rounded-md bg-white w-50 h-20 justify-evenly pt-5">
              ...
              <div>
                <p class="text-black text-xl pt-1">0%</p>
      ...
      <!-- Course and Skill -->
      <div class="flex flex-row mt-5 space-x-3 mb-5">
